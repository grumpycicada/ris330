/* Sample Databse to be used for all the labs in RIS330 course, keep this script file and the given ERD for reference */
/* Edited by Asma Paracha, Sep 2020 */
...
/* First check  to delete any previously available database */
DROP DATABASE IF  EXISTS classicmodels;

/* Now create the database */
CREATE DATABASE  classicmodels; 

/* To tell MySQL which database to use */
USE classicmodels;
